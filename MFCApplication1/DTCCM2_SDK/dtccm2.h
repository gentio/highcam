...
/// @brief 不发送sensor i2c 写的过程的stop命令
/// 
...
/// @brief 获取Parallel接口控制码
/// 
/// @param pdwCtrl：返回Parallel接口控制码
///
/// @retval DT_ERRORO_OK： 获取成功
...
/// @brief 图像抓拍设置，设置使能和一次抓拍的帧数,最大支持255。
///
