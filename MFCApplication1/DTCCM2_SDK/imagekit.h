...
/// @brief 未连接到设备
#define DS_ERROR_UNCONNECTED					-7		///<未连接到设备
/// @brief 功能无效
#define DS_ERROR_NOT_VALID						-8		///<功能无效
/// @brief 设备没打开
#define DS_ERROR_UNPLAY							-9		///<设备没打开
/// @brief 未启动
#define DS_ERROR_NOT_STARTED					-10		///<未启动
/// @brief 未停止
#define DS_ERROR_NOT_STOPPED					-11		///<未停止
/// @brief 未准备好
#define DS_ERROR_NOT_READY						-12		///<未准备好
/// @brief 错误的描述
#define DS_ERROR_DESCR_FAULT					-20		///<错误的描述
/// @brief 错误的名称
#define DS_ERROR_NAME_FAULT						-21		///<错误的名称
/// @brief 错误的赋值
#define DS_ERROR_VALUE_FAULT					-22		///<错误的赋值
/// @brief 被限制
#define DS_ERROR_LIMITED						-28		///<被限制
/// @brief 功能无效
#define DS_ERROR_FUNCTION_INVALID				-29		///<功能无效
/// @brief 在自动进行中，手动方式无效
#define DS_ERROR_IN_AUTO						-30		///<在自动进行中，手动方式无效
/// @brief 操作被拒绝
#define DS_ERROR_DENIED							-31     ///<操作被拒绝
/// @brief 偏移或地址未对齐
#define DS_ERROR_BAD_ALIGNMENT					-40     ///<偏移或地址未对其
/// @brief 地址无效
#define DS_ERROR_ADDRESS_INVALID				-41     ///<地址无效
/// @brief 数据块大小无效
#define DS_ERROR_SIZE_INVALID					-42     ///<数据块大小无效
/// @brief 数据量过载
#define DS_ERROR_OVER_LOAD						-43     ///<数据量过载
/// @brief 数据量不够
#define DS_ERROR_UNDER_LOAD						-44     ///<数据量不够
/// @breif Buffer空间太小
#define DS_ERROR_BUFFER_SMALL					-52		///<Buffer空间太小
/// @brief 检查、校验失败
#define DS_ERROR_CHECKED_FAILED					-50     ///<检查、校验失败
/// @brief 不可用
#define DS_ERROR_UNUSABLE						-51		///<不可用
/// @brief 业务ID无效或不匹配
#define DS_ERROR_BID_INVALID					-52		///<业务ID无效或不匹配
...
/// @brief 格式错误
#define DS_ERROR_FORMAT_INVALID					-1004	///<格式错误
/// @brief 内容无效
#define DS_ERROR_CONTENT_INVALID				-1005	///<内容无效
/// @brief 数据校验错误
#define DS_ERROR_BAD_CHECKSUM					-1006   ///<数据校验错误
/// @brief I2C总线错误
#define DS_ERROR_I2C_FAULT						-1010	///<I2C总线错误
/// @brief I2C等待应答超时
#define DS_ERROR_I2C_ACK_TIMEOUT				-1011	///<I2C等待应答超时
/// @brief I2C等待总线动作超时，例如SCL被外部器件拉为低电平
#define DS_ERROR_I2C_BUS_TIMEOUT				-1012	///<I2C等待总线动作超时，例如SCL被外部器件拉为低电平
/// @brief SPI总线错误
#define DS_ERROR_SPI_FAULT						-1020	///<SPI总线错误
/// @brief UART总线错误
#define DS_ERROR_UART_FAULT						-1030	///<UART总线错误
/// @brief GPIO总线错误
#define DS_ERROR_GPIO_FAULT						-1040	///<GPIO总线错误
/// @brief USB总线错误
#define DS_ERROR_USB_FAULT						-1050	///<USB总线错误
/// @brief PCI总线错误
#define DS_ERROR_PCI_FAULT						-1060	///<PCI总线错误
/// @brief 物理层错误
#define DS_ERROR_PHY_FAULT						-1070	///<物理层错误
/// @brief 链路层错误
#define DS_ERROR_LINK_FAULT						-1080	///<链路层错误
/// @brief 传输层错误
#define DS_ERROR_TRANS_FAULT					-1090	///<传输层错误
...
/// @brief 设备已经被其他主机打开
#define DS_ERROR_DEVICE_IS_OPENED_BY_ANOTHER	-1105	///设备已经被其他主机打开
/// @brief 内核驱动出现问题
#define DS_ERROR_KERNEL_DRIVER_PROBLEM			-1106	///内核驱动出现问题
/// @brief 网络套接出现问题
#define DS_ERROR_SOCKET_PROBLEM					-1107	///网络套接出现问题

/// @brief 没有足够系统内存
#define DT_ERROR_NO_MEMORY  	   		   		-1200	///<没有足够系统内存
/// @brief 存储器读写出现误码或无法正常读写
#define DS_ERROR_MEM_FAULT						-1201	///<存储器读写出现误码或无法正常读写
/// @brief 写保护，不可写
#define DS_ERROR_WRITE_PROTECTED          		-1202  	///<写保护，不可写
...
/// @brief 读取文件失败
#define DS_ERROR_FILE_READ_FAILED				-1302  	///<读取文件失败
/// @brief 写入文件失败
#define DS_ERROR_FILE_WRITE_FAILED				-1303  	///<写入文件失败
/// @brief 打开文件失败
#define DS_ERROR_FILE_OPEN_FAILED				-1304	///<打开文件失败
/// @brief 读取数据较检失败
#define DS_ERROR_FILE_CHECKSUM_FAILED			-1305  	///<读取数据较检失败
...
/// @brief 数据采集已经停止
#define DS_ERROR_GRAB_IS_STOPPED         		-1606  	///<数据采集已经停止
/// @brief 数据采集正在重启
#define DS_ERROR_GRAB_IS_RESTARTING				-1607	///<数据采集正在重启
/// @brief 设置的ROI参数无效
#define DS_ERROR_ROI_PARAM_INVALID				-1610   ///<设置的ROI参数无效
/// @brief ROI功能不支持
#define DS_ERROR_ROI_NOT_SUPPORTED				-1611   ///<ROI功能不支持
